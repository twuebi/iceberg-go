...
// ValidateRowLineage validates v3 row lineage fields.
// Returns an error if first-row-id is set but added-rows is not,
// or if either field has an invalid negative value.
